function source = senddatafunction(controller, channelname, data)
...
%   This function should be called when sending data packets after the
...
% sends the data to DataTurbin
controller.callSendData(channelname,data);
source = 1;